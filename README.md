# AI & Data Quality Portfolio

This portfolio contains 5 projects simulating Safety Labeling, Search Quality, Ecosystem monitoring, and Annotation QA. 
...
**AI tools disclosure: Text samples (queries and video descriptions) were produced by ChatGPT to simulate real-world inputs.

# Portfolio structure 
```
README.md
project1_safety_labeling/
project2_search_quality_evaluation/
project3_annotation_qa/
project4_search_ranking/
project5_ecosystem_monitoring/
```
# Project Summaries
